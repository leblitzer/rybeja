...
// YBO 08/05/2020 : Réécriture des méthodes natives
...
9 xxxNN
	*/
	...
	public  void destroy(){}
	public  int isInited(){return 0;}
	public  int requestMove(int from, int to){return 0;}
	public  int move(int move){return 0;}
	public  void undo(){}
	public  void reset() {}
	public void putPiece(int pos, int piece, int turn) {}
	public  void searchMove(int secs){}
	public  void searchDepth(int depth){}
	public  int getMove(){return 0;}
	public  int getBoardValue(){return 0;}
	public  int peekSearchDone(){return 0;}
	public  int peekSearchBestMove(int ply){return 0;}
	public  int peekSearchBestValue(){return 0;}
	public  int peekSearchDepth(){return 0;}
	public  int getEvalCount(){return 0;}
	public  void setPromo(int piece){}
	public   int getState(){return 0;}
	public   int isEnded(){return 0;}
	public void setCastlingsEPAnd50(int wccl, int wccs, int bccl, int bccs, int ep, int r50){}
	public   int getNumBoard(){return 0;}
	public   int getTurn(){return 0;}
	public void commitBoard(){}
	public  void setTurn(int turn){}
	//public native int[] getMoveArray();
	public   int getMoveArraySize(){return 0;}
	public   int getMoveArrayAt(int i){return 0;}
	public  int pieceAt(int turn, int pos) {return 0;}
	public String getMyMoveToString(){return "";}
	public  int getMyMove(){return 0;}
	public  int isLegalPosition(){return 0;}
	public  int isAmbiguousCastle(int from, int to){return 0;}
	public  int doCastleMove(int from, int to){return 0;}
	public  String toFEN(){return "";}
	public  void removePiece(int turn, int pos){}
	public  long getHashKey(){return 0;}
	public  void loadDB(String sFile, int depth){}
	public  void interrupt(){}
	public  int getNumCaptured(int turn, int piece){return 0;}

	static {
		// YBO 08/05/2020 System.loadLibrary("chess-jni");
	}
}