package rybeja.android.chess.tools;
...
import rybeja.android.chess.MyPGNProvider;
import rybeja.android.chess.R;
import rybeja.chess.PGNColumns;
import rybeja.chess.algorithm.UCIWrapper;
...
public class pgntool extends ListActivity {
    ...
    // YBO 08/05/2020 protected static final String EXTRA_MODE = "jwtc.android.chess.tools.Mode";
    protected static final String EXTRA_MODE = "rybeja.android.chess.tools.Mode"; // YBO 08/05/2020
        ...
        _lvStart.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
                ...
                if (arrString[arg2].equals(getString(R.string.pgntool_export_explanation))) {
                            ...
                            builder.setItems(arrItems, new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int item) {
                                    ...
                                    try {
                                        ...
                                        // YBO 08/05/2020 UCIWrapper.runConsole("/system/bin/chmod 744 /data/data/jwtc.android.chess/*");
                                        UCIWrapper.runConsole("/system/bin/chmod 744 /data/data/rybeja.android.chess/*"); // YBO 08/05/2020
                    ...
                    if (sEngine != null) {
                        // YBO 08/05/2020 File f = new File("/data/data/jwtc.android.chess/" + sEngine);
                        File f = new File("/data/data/rybeja.android.chess/" + sEngine); // YBO 08/05/2020
                        if (f.delete()) {
                    ...
                    if (sDatabase != null) {
                        // YBO 08/05/2020 File f = new File("/data/data/jwtc.android.chess/" + sDatabase);
                        File f = new File("/data/data/rybeja.android.chess/" + sDatabase); // YBO 08/05/2020
                        if (f.delete()) {
