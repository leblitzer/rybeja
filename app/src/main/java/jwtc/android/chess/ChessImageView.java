...
public class ChessImageView extends View {
	...
	public static int _arrColorSchemeLength=8; // YBO 28/01/2020
	public static int[][] _arrColorScheme = new int[_arrColorSchemeLength][3];
    ...
    public void onDraw(Canvas canvas) {
        ...
        if(hasFocus()){
			...
			if (_colorScheme == _arrColorSchemeLength){ // _arrColorSchemeLength is color picker
