...
public class MyBaseActivity extends android.app.Activity{
	...
	public PowerManager.WakeLock getWakeLock(){
		...
		// return pm.newWakeLock(PowerManager.SCREEN_DIM_WAKE_LOCK, "DoNotDimScreen"); // YBO 14/02/2020
		return pm.newWakeLock(PowerManager.SCREEN_DIM_WAKE_LOCK, "MyBaseActivity:DoNotDimScreen"); // YBO 14/02/2020
	}
