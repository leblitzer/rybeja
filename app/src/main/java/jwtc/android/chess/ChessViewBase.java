...
/**
 * YBO : 28/01/2020 : Ajout du bleu clair
 */
public class ChessViewBase{
	...
	public void init(OnClickListener ocl, OnLongClickListener olcl){
		...
		*/
		int ic =0;
		// yellow
		ChessImageView._arrColorScheme[ic][0] = 0xffdeac5d;
		ChessImageView._arrColorScheme[ic][1] = 0xfff9e3c0;
		ChessImageView._arrColorScheme[ic][2] = 0xccf3ed4b;
		ic++;
		// blue
		ChessImageView._arrColorScheme[ic][0] = 0xff28628b;
		ChessImageView._arrColorScheme[ic][1] = 0xff7dbdea;
		ChessImageView._arrColorScheme[ic][2] = 0xcc9fdef3;
		ic++;
		// light blue
		ChessImageView._arrColorScheme[ic][0] = 0xFF7085B6;
		ChessImageView._arrColorScheme[ic][1] = 0xFFE6E6E6;
		ChessImageView._arrColorScheme[ic][2] = 0xCC9fdef3;
		ic++;

		// green
		ChessImageView._arrColorScheme[ic][0] = 0xff8eb59b;
		ChessImageView._arrColorScheme[ic][1] = 0xffcae787;
		ChessImageView._arrColorScheme[ic][2] = 0xcc9ff3b4;
		ic++;
		// grey
		ChessImageView._arrColorScheme[ic][0] = 0xffc0c0c0;
		ChessImageView._arrColorScheme[ic][1] = 0xffffffff;
		ChessImageView._arrColorScheme[ic][2] = 0xccf3ed4b;
		ic++;
		// brown
		ChessImageView._arrColorScheme[ic][0] = 0xff65390d; //4c2b0a
		ChessImageView._arrColorScheme[ic][1] = 0xffb98b4f;
		ChessImageView._arrColorScheme[ic][2] = 0xccf3ed4b;
		ic++;
		// 347733
		// red
		ChessImageView._arrColorScheme[ic][0] = 0xffff2828;
		ChessImageView._arrColorScheme[ic][1] = 0xffffd1d1;
		ChessImageView._arrColorScheme[ic][2] = 0xccf3ed4b;
		ic++;
		// Abstract
		ChessImageView._arrColorScheme[ic][0] = 0xcc28628b;
		ChessImageView._arrColorScheme[ic][1] = 0xcc28628b;
		ChessImageView._arrColorScheme[ic][2] = 0xcc28628b;
		ic++;
        // FIN YBO 28/01/2020
